...
export class AccountService {
 ...
 // the method to get the data from the api
      ...
      this.http.get<ApiResponse>(apiUrl)
        ...
        .then(
          (res) => {
            ...
            this.accountDetails.login = "An error occured!"
            this.accountDetails.url = "An error occured!"
  ...
  getRepos(userName: string): Observable<Repo[]> {
    ...
    let apiUrl = this.url + userName + '/repos?client_id='+this.clientid+'&client_secret='+this.clientsecret
